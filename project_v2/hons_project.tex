...
\chapter{Background}
\import{chapters/}{2 - Background.tex}

\chapter{A formal definition of \texorpdfstring{$\csp$}{CSP} and \texorpdfstring{$\acptf$}{ACP}}
\import{chapters/}{3 - Languages.tex}

\chapter{A Translation of \texorpdfstring{$\csp$}{CSP} to \texorpdfstring{$\acptf$}{ACP}}
\import{chapters/}{4 - Translation.tex}


\newpage
\chapter{Validity of the Encoding}
\import{chapters/}{5 - Validity.tex}

\chapter{Results}
\import{chapters/}{6 - Results.tex}

\chapter{Conclusions}
\import{chapters/}{7 - Conclusions.tex}
