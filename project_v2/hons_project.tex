...
\abstract{
   A popular technique for representing processes in Concurrency Theory is categorised into models called Process Algebras. Many Process Algebras exist, and efforts have been made to contextualise different Algebras against each other to find out notions of which Algebra are ``better''.
