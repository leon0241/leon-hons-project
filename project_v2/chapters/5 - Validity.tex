...
\begin{proof}
	...
	\]
	for every trace in $Q$. Via Lemma \ref{lma:tau-on-p-process}, this process is Branching Bisimilar to the process $\trans{P'}$, and therefore, as the first action is related Strongly, the process is also Rooted Branching Bisimilar when taking an $a$ action on $P$.
