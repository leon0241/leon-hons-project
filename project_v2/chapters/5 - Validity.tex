...
A relation $R$ is a \textbf{Branching Bisimulation} between two processes $P$ and $Q$ if:
\begin{enumerate}
...
\begin{proof}
	...
	We have now exhausted all cases, and therefore can conclude that our translation of $\csp$ External Choice is Rooted Branching Bisimilar, and therefore Compositional.. WIP.
\end{proof}
