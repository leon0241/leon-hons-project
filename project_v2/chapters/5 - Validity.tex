...
\begin{proof}
	...
	\begin{itemize}[leftmargin=*]
		\item Let $P'$ such that $P \prightarrow{a} P'$. In the domain of CSP, this results in the process:
		      ...
		      \end{align*}
		      Note that the move $a$ results from $\fdef{post}$ applied to $a_{post}$, similarly to in the parallel composition operator. This is a common occurance, and from now on we will accept that this is the behaviour that will happen.
