...
\displaystyle\frac{P\prightarrow{\alpha} P'~~{\scriptstyle(\alpha\notin A)}}{P\throw Q \prightarrow{a} P'\throw Q} &
\displaystyle\frac{P\prightarrow{a} P'~~{\scriptstyle(a\in A)}}{P\throw Q \prightarrow{a} Q}\\[4ex]
\displaystyle\frac{P\prightarrow{\alpha} P'}{P\interrupt Q \prightarrow{\alpha} P'\interrupt Q} &
\displaystyle\frac{Q\prightarrow{\tau} Q'}{P\interrupt Q \prightarrow{\tau} P'\interrupt Q'} &
\displaystyle\frac{Q\prightarrow{a} Q'}{P\interrupt Q \prightarrow{a} Q'} &
